...
if  lapalma ne 0 then begin
	...
	earth_longitude = 105.82*rpd
				    ...
				    ;
if  n_elements(tenerife) eq 0  then  tenerife = 0
if  tenerife ne 0 then begin
				    ;
				    ;Tenerife on keyword.
				    ;
	earth_latitude  = (28.+18./60.+00./3600.)*rpd
	earth_longitude = (16.+30./60.+35./3600.)*rpd
				    ;
end else begin
				    ;
				    ;Sacramento Peak default.
