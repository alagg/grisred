pro get_calib_v5,filecal,dmod1,dmod2,data=data,lambda=lambda,zbad=zbad,$
...
if(pos_tel eq -1 and pos_ins ne -1) then begin	; instrumental calibration
   print,'INSTRUMENTAL CALIBRATION'
