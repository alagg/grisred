...
tel_ref1=gregormod_v5(elaz[0],elaz[1],derotator_angle,decsun,p0,/POLCALIB,xtau=xtau,$
                   lambda=lambda/10.)
...
; ask if derotator is inserted
   ...
   tel_ref2=gregormod_v5(elaz[0],elaz[1],derotator_angle,decsun,p0,/POLCALIB,xtau=xtau, $
                      lambda=lambda/10.)
endelse  
...
if(min(abs(rotcode)) eq 0) then begin
   ...
   derotator_angle_start=500.
   derotator_angle_end=500.
...
;         endelse
         ...
         mat_tel=gregormod_v5(elaz[0],elaz[1],derotator_angle,decsun,p0,xtau=xtau,lambda=lambda/10.)
         mat_tel=invert(mat_tel)
